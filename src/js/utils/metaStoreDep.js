...
function getFieldByID (idName, idValue, fieldName, xdata) {
  ...
  if (idName === 'dept_id_ck') r = ['dept_id_ck', 'dept_ck']
  if (r) {
...
export {getCardBindObjectInfo, getCardTypeName, getCardTypeInfo, getCardTypeID, getCardInfo, getCurrentShiftID, getNameByID, formatStateArray, getVehicleDriver, formatRecord, formatRecordArray, formatField}
